export default {
  commands: {
    ...
    create: {
      ...
      queue_description:
        "Você acabou de criar uma partida, chame seus amigos para jogar junto com você!",
      players: "Jogadores",
      messages: {
    ...
    play: {
      ...
      messages: {
        ...
        report:
          "O jogador esqueceu de dizer `UNO!`, corra e reporte para puni-lo!",
      },
    },
    vote: {
      ...
      embed: {
        description:
          "Qualquer gesto já ajuda o nosso bot a crescer cada vez mais. Vote abaixo clicando nos botões para ser redirecionado",
      },
    },
    invite: {
  ...
  game: {
    ...
    embeds: {
      resume: {
        ...
        footer:
          "Use /play para fazer a sua jogada, ou use /draw para comprar uma carta",
      },
      end: {
        descriptions: {
          inactivity:
            "Todos os jogadores ficaram inativos. A partida foi encerrada",
          no_more_players:
            "A partida acabou. Parabéns ao vencedor {0} !!\nRanking de vencedores:",
        },
        footer: "Ajude o nosso bot usando o comando /vote <3",
      },
    },
    punished_by_report:
      "O jogador {0} esqueceu de dizer ` Uno! ` e ganhou +2 cartas",
  ...
  errors: {
    missing_permissions:
      "Preciso das permissões: ` Inserir Links, Ver canal e Enviar mensagem ` para funcionar corretamente",
    command_spam:
      "Você está usando os comandos muito de pressa! Espere mais ` {0} ` segundos",
    ...
    missing_host_permissions:
      "Apenas quem criou a partida pode começá-la ou cancelá-la",
    insufficient_players:
      "Não há jogadores o suficiente para começar uma partida",
    ...
    card_not_found:
      "Não encontrei essa carda no meio do seu Deck, tem certeza de que digitou corretamente?",
