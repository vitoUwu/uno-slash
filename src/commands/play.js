  ...
  async slashExecute(interaction) {
    ...
    if (!game)
      return await interaction.reply({
        embeds: [error(locales(interaction.locale, "commands.play.noMatchs"))],
        ephemeral: true,
      });
    ...
    if (!game.started)
      return await interaction.reply({
        embeds: [
          error(locales(interaction.locale, "commands.play.notStarted")),
        ],
        ephemeral: true,
      });
    ...
    if (game.whoPlaysNow?.member.id !== interaction.member.id)
      return await interaction.reply({
        embeds: [error(locales(interaction.locale, "commands.play.notTurn"))],
        ephemeral: true,
      });
    ...
    if (!player)
      return await interaction.reply({
        embeds: [
          error(locales(interaction.locale, "commands.play.notParticipating")),
        ],
        ephemeral: true,
      });
  ...
  async autocompleteExecute(interaction) {
    ...
    if (!game)
      return await interaction.respond([
        {
          name: locales(interaction.locale, "commands.play.noMatchs"),
          value: locales(interaction.locale, "commands.play.noMatchs"),
        },
      ]);
    ...
    if (!game.started)
      return await interaction.respond([
        {
          name: locales(interaction.locale, "commands.play.notStarted"),
          value: locales(interaction.locale, "commands.play.notStarted"),
        },
      ]);
    ...
    if (!player)
      return await interaction.respond([
        {
          name: locales(interaction.locale, "commands.play.notParticipating"),
          value: locales(interaction.locale, "commands.play.notParticipating"),
        },
      ]);
    ...
    let data = player.cards
      .filter(
        (cardId) =>
          ...
          game.parseCardId(cardId).toString().toLowerCase().includes(value)
      )
