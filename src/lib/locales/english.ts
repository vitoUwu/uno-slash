export default {
	commands: {
		...
		create: {
			...
			queue_description: 'You just created a match, call your friends to play with you!',
			players: 'Players',
			messages: {
				started: 'Starting',
			...
			maintenance: 'The bot is in maintenance mode, try again later'
		},
		draw: {
		...
		help: {
			...
			draw: {
				...
				description: 'If none of your cards match the table card, you can buy a new card and pass your turn using the `draw` command'
			},
			leave: {
		...
		play: {
			...
			messages: {
				played: {
					...
					'4wild': '{0} played a wild +4 and changed the color of the match\n{1} received +4 cards and now has `{2}` cards',
				...
				'stacked+2': '{0} played a +2 card, the accumulation of +2 cards is at {1}',
				finished_stacking:
		...
		vote: {
			...
			embed: {
				description: 'It helps our bot grow more and more. Vote below by clicking the buttons to be redirected'
			}
		},
		invite: {
	...
	game: {
		...
		punished_by_inactivity: '{0} took a long time to play and your turn was passed.\n{0} received +{2} cards. Now {0} has ` {1} ` cards',
		report: 'Report',
		embeds: {
			resume: {
				...
				descriptions: {
					...
					no_more_players: 'The match is over. Congratulations to the winner {0} !!  Ranking of winners:'
				},
				footer: 'Help our bot using /vote <3'
			},
			cards: {
				footer: '{0} cards remaining'
			}
		},
	...
	player: {
		messages: {
			played_last_card: '{0} played his last card `{1}`'
		}
	},
	errors: {
		...
		missing_host_permissions: 'Only those who created the match can start or cancel it',
	...
	select_menus: {
		select_your_card: 'Select a Card',
		draw: {
			label: 'Buy Card',
			description: "You don't have any playable cards"
		}
	}
};
