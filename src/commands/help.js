					...
					fields: [
						{
							...
							value: locales(interaction.locale, "commands.help.create.description"),
							inline: true,
						},
						{
							name: locales(interaction.locale, "commands.help.play.title"),
							value: locales(interaction.locale, "commands.help.play.description"),
							inline: true,
						},
						{
							name: locales(interaction.locale, "commands.help.draw.title"),
							value: locales(interaction.locale, "commands.help.draw.description"),
							inline: true,
						},
						{
							name: locales(interaction.locale, "commands.help.leave.title"),
							value: locales(interaction.locale, "commands.help.leave.description"),
							inline: true,
						},
					],
				},
